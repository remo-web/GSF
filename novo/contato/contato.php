...
//nome
if (empty($_POST["gsf-contato-nome"])) {
    $error .= "Name is required ";
} else {
    $nome = $_POST["gsf-contato-nome"];
}

//email
if (empty($_POST["gsf-contato-email"])) {
    $error .= "Email is required ";
} else {
    $email = $_POST["gsf-contato-email"];
}

//mensagem
if (empty($_POST["gsf-contato-mensagem"])) {
    $error .= "Mensagem is required ";
} else {
    $mensagem = $_POST["gsf-contato-mensagem"];
}
 
$To = "embarque@gsf.eco.br";
